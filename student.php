...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Estudiante
						<?php
echo (isset($_GET['action']) && @$_GET['action'] == "add" || @$_GET['action'] == "edit") ?
' <a href="student.php" class="btn btn-primary btn-sm pull-right">Atrás <i class="glyphicon glyphicon-arrow-right"></i></a>' : '<a href="student.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Nuevo estudiante</a>';
?>
						</h1>
...
$sql = "select * from branch where delete_status='0' order by branch.branch asc";
    ...
    ?>
						...
						<div class="form-group">
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Información de pago:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Total/Curso Gs.* </label>
								<div class="col-sm-10">
...
if ($action == "add") {
        ?>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Primer Pago* </label>
								<div class="col-sm-10">
    ...
    ?>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Saldo </label>
								<div class="col-sm-10">
...
if ($action == "add") {
        ?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Concepto </label>
								<div class="col-sm-10">
