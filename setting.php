...
$error = '<div class="alert alert-danger">
  ...
  <strong>Error!</strong> Contraseña vieja incorrecta
</div>';
}
...
echo '<div class="alert alert-success">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Muy bien!</strong> Cambio de contraseña con éxito.
</div>';
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old">Contraseña anterior</label>
								<div class="col-sm-5">
    ...
    <div id="footer-sec">
        Sistema de Cuotas y Matriculas | ROCEMI Academia Integral de Artes de Encarnación 
    </div>
    ...
    <script src="js/custom1.js"></script>
		...
		$( document ).ready( function () {			
			...
			$( "#signupForm1" ).validate( {
				...
				messages: {
					oldpassword: "Por favor introduzca su contraseña anterior",
